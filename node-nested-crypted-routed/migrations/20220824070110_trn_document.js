...
exports.up = async function (knex) {
  await knex.schema.createTable('mst_document_module', (table) => {
    table
      .bigint('document_type_id', 20)
      .notNullable()
      .index('document_type_id', {
        constraintName: 'fk_ms_document_type_id',
        deferrable: 'deferred',
        storageEngineIndexType: 'BTREE',
      });
    table.bigint('ms_module_id', 20).notNullable().index('document_type_id', {
      constraintName: 'fk_ms_document_type_module_id',
      deferrable: 'deferred',
      storageEngineIndexType: 'BTREE',
    });
  });

  // await knex.schema.alterTable('mst_document_module', (table) => {
  //   table.index;
  // });
