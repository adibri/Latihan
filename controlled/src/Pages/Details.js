        ...
        <h1 className='text-5xl font-bold text-center p-20'> Details </h1>
          <div key={{pokemonId}} className='poke-details flex justify-center'>
              ...
              <div className='poke-info'>
                  ...
                  <h1 className='text-2xl py-2'> Type: </h1>
                  <div className='poke-type flex-inline'>
                    { 
                      locationState.dataParams.types.map((items) => (
                          <h1 className='pl-10 py-2 text-xl'> {items.type.name} </h1>
                          )) 
                    }
                  </div>
              </div>
